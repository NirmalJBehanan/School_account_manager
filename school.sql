...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 11:53 AM
...
INSERT INTO `academic_year` (`ay_id`, `academic_year`, `current_ay`, `status`) VALUES
(1, '2023-2024', 0, 1),
(2, '2024-2025', 1, 1);
...
(1, 'contenttypes', '0001_initial', '2024-11-06 09:41:07.958990'),
(2, 'auth', '0001_initial', '2024-11-06 09:41:08.177722'),
(3, 'admin', '0001_initial', '2024-11-06 09:41:08.224594'),
(4, 'admin', '0002_logentry_remove_auto_add', '2024-11-06 09:41:08.240220'),
(5, 'admin', '0003_logentry_add_action_flag_choices', '2024-11-06 09:41:08.255845'),
(6, 'contenttypes', '0002_remove_content_type_name', '2024-11-06 09:41:08.287092'),
(7, 'auth', '0002_alter_permission_name_max_length', '2024-11-06 09:41:08.318338'),
(8, 'auth', '0003_alter_user_email_max_length', '2024-11-06 09:41:08.318338'),
(9, 'auth', '0004_alter_user_username_opts', '2024-11-06 09:41:08.333963'),
(10, 'auth', '0005_alter_user_last_login_null', '2024-11-06 09:41:08.349595'),
(11, 'auth', '0006_require_contenttypes_0002', '2024-11-06 09:41:08.349595'),
(12, 'auth', '0007_alter_validators_add_error_messages', '2024-11-06 09:41:08.365211'),
(13, 'auth', '0008_alter_user_username_max_length', '2024-11-06 09:41:08.380835'),
(14, 'auth', '0009_alter_user_last_name_max_length', '2024-11-06 09:41:08.380835'),
(15, 'auth', '0010_alter_group_name_max_length', '2024-11-06 09:41:08.396467'),
(16, 'auth', '0011_update_proxy_permissions', '2024-11-06 09:41:08.412082'),
(17, 'auth', '0012_alter_user_first_name_max_length', '2024-11-06 09:41:08.427705'),
(18, 'schoolapp', '0001_initial', '2024-11-06 09:41:08.912044'),
(19, 'sessions', '0001_initial', '2024-11-06 09:41:08.927678');
...
('7v0tiv0x65h8rod6vf6uxwei4nl0zbrh', 'eyJsb2dpbl9pZCI6MSwibWFzdGVyIjoxfQ:1t8d85:mVUAdVkgee6qwyTD13HSort4HmYYLwHXqUJb0CygE3s', '2024-11-20 10:19:13.409526'),
('9qczfy9ve6wwznxh5fjjx4hi5xql6v69', 'eyJsb2dpbl9pZCI6MiwiYWNjb3VudGFudCI6MSwic3RhZmZfaWQiOjF9:1t8dEp:Eh67RZZb7q2x2eF1n93Jmg_-Orl0gZaMvIS73bhQdWw', '2024-11-20 10:26:11.558183'),
('d6ll10qj3z5lv39tb1s9eybpxq8au1zq', 'eyJsb2dpbl9pZCI6NSwic3R1ZGVudCI6MX0:1t8dSJ:P70ynZCWC0A_nFw2x8Noo3vLWsiWK1wYdLAXcY-X204', '2024-11-20 10:40:07.026114');
...
(2, 'sam@gmail.com', 'LuQ!tE2@', 'Accountant', 1),
(3, 'john@gmail.com', 'C9OsPawB', 'Office staff', 1),
(4, 'ram@gmail.com', 'z!JC8h0x', 'Faculty', 1),
(5, '12344', '12344', 'Student', 1);
...
INSERT INTO `salary_table` (`st_id`, `account_category`, `basic_pay`, `da`, `hra`, `ta`, `agp`, `status`, `designation_id`) VALUES
(1, 'Expense', 30000, 1, 2, 3, 2, 1, 1),
(2, 'Expense', 25000, 2, 1, 3, 4, 1, 2),
(3, 'Expense', 30000, 2, 3, 2, 1, 1, 3),
(4, 'Expense', 35000, 3, 2, 3, 1, 1, 4),
(5, 'Expense', 40000, 3, 1, 2, 1, 1, 5),
(6, 'Expense', 45000, 2, 2, 1, 3, 1, 6);
...
CREATE TABLE `salary_transaction` (
  ...
  `da_amount` double DEFAULT NULL,
  `hra_amount` double DEFAULT NULL,
  `ta_amount` double DEFAULT NULL,
  `agp_amount` double DEFAULT NULL,
...
INSERT INTO `salary_transaction` (`st_id`, `bonus`, `deductions`, `da_amount`, `hra_amount`, `ta_amount`, `agp_amount`, `basic_pay`, `salary_date`, `approval_status`, `academic_year_id`, `salary_table_id`, `staff_id`) VALUES
(1, 0, 0, 300, 600, 900, 600, 30000, '2024-01-31', 'Approved', 2, 1, 1),
(2, 10, 0, 500, 250, 750, 1000, 25000, '2024-01-31', 'Approved', 2, 2, 2),
(3, 20, 0, 600, 900, 600, 300, 30000, '2024-01-31', 'Approved', 2, 3, 3),
(4, 0, 0, 300, 600, 900, 600, 30000, '2024-02-29', 'Approved', 2, 1, 1),
(5, 0, 0, 600, 900, 600, 300, 30000, '2024-02-29', NULL, 2, 3, 3),
(6, 0, 0, 500, 250, 750, 1000, 25000, '2024-02-29', 'Approved', 2, 2, 2);
...
(1, 'Expense', 'School maintanance', 1);
...
--
-- Dumping data for table `school_finance_transaction`
--

INSERT INTO `school_finance_transaction` (`sft_id`, `description`, `total_amount`, `entry_date`, `approval_status`, `academic_year_id`, `school_finance_id`) VALUES
(1, 'Roof maintanance', 20000, '2024-11-06', 'Approved', 1, 1);
...
INSERT INTO `staff_leave` (`sl_id`, `reason`, `start_date`, `end_date`, `no_of_days`, `created_at`, `status`, `leave_type_id`, `staff_id`) VALUES
(1, 'I want leave', '2024-11-07', '2024-11-08', 2, '2024-11-06 10:15:11.193866', 'Approved', 1, 1),
(2, 'I can\'t come the given date', '2024-11-07', '2024-11-08', 2, '2024-11-06 10:31:47.183284', NULL, 3, 2);
...
(1, 'Sam', 8645784744, 'Sam villa', '/media/team-1.jpg', 1, 2),
(2, 'John', 7890987645, 'John villa', '/media/testimonial-2.jpg', 2, 3),
(3, 'Ram', 9876754567, 'Ram bhavan', '/media/team-3.jpg', 3, 4);
...
--
-- Dumping data for table `student_fee_transaction`
--

INSERT INTO `student_fee_transaction` (`sft_id`, `total_amount`, `payment_date`, `created_at`, `academic_year_id`, `student_id`, `student_fee_id`) VALUES
(1, 1050, '2024-06-01', '2024-11-06', 2, 1, 1),
(2, 1050, '2024-07-01', '2024-11-06', 2, 1, 1);
...
INSERT INTO `student_register` (`sr_id`, `name`, `email`, `contact_number`, `address`, `image`, `gender`, `login_id`, `standard_id`) VALUES
(1, 'Manu', 'manu@gmail.com', 9876543456, 'Manu Villa', '/media/testimonial-3_C3gdnV1.jpg', 'male', 5, 1);
...
--
ALTER TABLE `school_finance_transaction`
  MODIFY `sft_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
